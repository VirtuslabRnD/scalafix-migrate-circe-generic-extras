...
object CirceDerivationAnnotations {
  ...
  object jsonCodecWithJsonKey {
    ...
    case class CClass1(name: String)
    object CClass1 {
  given Codec[CClass1] = ConfiguredCodec.derived(using Configuration.default.withTransformConstructorNames {
    case "name" =>
      "id"
    case name =>
      Configuration.default.transformConstructorNames(name)
  })
}
    case class CClass1Generic1[T](v: T)
    object CClass1Generic1 {
  given [T: Encoder: Decoder]: Codec[CClass1Generic1[T]] = ConfiguredCodec.derived(using Configuration.default.withTransformConstructorNames {
    case "v" =>
      "firstValue"
    case name =>
      Configuration.default.transformConstructorNames(name)
  ...
  given [A: Encoder: Decoder, B: Encoder: Decoder]: Codec[CClass2Generic2[A, B]] = ConfiguredCodec.derived(using Configuration.default.withTransformConstructorNames {
    case "a" =>
      "first"
    case "b" =>
      "secondValue"
